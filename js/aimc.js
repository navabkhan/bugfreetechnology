...
/* 	document.addEventListener('contextmenu', event => event.preventDefault()); */
	/* $("#frm_appointment").submit(function (event) {
          ...
          var posting = $.post(url, { name: $('entry.2005620554').val(), email: $('entry.1045781291').val(), phone: $('entry.1065046570').val(), month: $('entry.839337160_month').val(), day: $('entry.839337160_day').val(), year: $('entry.839337160_year').val(), message: $('entry.1383611224').val() });
